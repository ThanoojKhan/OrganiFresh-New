...
user_route.get('/otpLogin',auth.loginSession,userController.otpLogin)
...
user_route.get('/otpPage',auth.loginSession,userController.otppage)
...
user_route.post('/userMessage',auth.logOutSession,userController.sendMessage)
...
user_route.get('/shippingPolicy',userController.loadShipping)

user_route.get('/termsConditions',userController.loadReturns)

user_route.get('/privacyPolicy',userController.loadPrivacy)
...
user_route.get('*',function(req,res){res.render("error")})
